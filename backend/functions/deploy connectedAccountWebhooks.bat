...
:PRO_DEPLOY
CD connectedAccountWebhooks
gcloud functions deploy connectedAccountWebhooks --runtime python310 --trigger-http --project flameoapp-pyme --region europe-central2 --entry-point handle_webhook --env-vars-file .env.yaml
GOTO END
